...
class Otp2Page extends StatelessWidget {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 20),
              AText(
                "Please check your mobile number 014*****13 to reset your password",
              ...
              SizedBox(height: 40),
              Button("Next", () => Navigator.pushNamed(context, '/reset-password-2')),
              SizedBox(height: 40),
              footer(context),
            ],
          ),
