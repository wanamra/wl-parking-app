...
class TerminateSeasonPage extends StatefulWidget {
  @override
  State<TerminateSeasonPage> createState() => _TerminateSeasonPageState();
}

class _TerminateSeasonPageState extends State<TerminateSeasonPage> {
